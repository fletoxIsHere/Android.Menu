        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            switch(item.getItemId()){
                ...
                case R.id.conversion:
                    getSupportFragmentManager().beginTransaction().replace(R.id.myframeLayout, new ConversionFragment()).commit();
                    drawerLayout.closeDrawer(GravityCompat.START);
                    break;

                case R.id.profile:
                    getSupportFragmentManager().beginTransaction().replace(R.id.myframeLayout, new ProfileFragment()).commit();
                    drawerLayout.closeDrawer(GravityCompat.START);
                    break;
